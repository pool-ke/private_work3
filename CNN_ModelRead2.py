...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 14 10:59:17 2018
...
def test_model(X_test):
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess,"./model_CNN6/model.ckpt")#./Model/model.ckpt
    
        pred=sess.run(prediction,{Xs:X_test,keep_prob:0.7})
        coord.request_stop()
        coord.join(threads)
