...
def CompressFileToPKL(SourceFolder,DstFile):
    AllImages=os.listdir(SourceFolder)
    image_buffer_dict={}
    for image_Id in AllImages:
        image_path=os.path.join(SourceFolder,image_Id)
        image_buffer_dict[image_Id]=open(image_path,'rb').read()
    with open(DstFile,'wb') as f:
        f.write(pickle.dumps(image_buffer_dict))
